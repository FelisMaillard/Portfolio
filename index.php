...
<head>
    ...
    <title>Portfolio Félis Maillard</title>
</head>
<header>
    <?php
    include 'header.php'
...
<body>
    <div class="body-container">
        ...
        <div class="body-container-i2">
            <div class="black">
                <h1>J'ai obtenu mon Bac en Spé NSI et LLCE !</h1>
            </div>
        </div>

    </div>

    <a id="scrollToTopButton" href="#" style="display: none;">
        <img src="img/haut.png" alt="Flèche vers le haut" class="retour_haut">
    </a>
